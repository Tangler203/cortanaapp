...
namespace cortanaApp
{
    ...
    sealed partial class App : Application
    {
            ...
            if (e.PrelaunchActivated == false)
            {
                ...
                try
                {
                    ...
                    StorageFile vcdFile = await
                        Package.Current.InstalledLocation.GetFileAsync(@"NumberGenieVCD.xml");
        ...
        protected async override void OnActivated(IActivatedEventArgs args)
        {
            ...
            {
                case "startNumberGenie":
                    {
                        System.Diagnostics.Debug.WriteLine("Play New Game");
                ...
                case "guessnumber":
                    {
                        ...
                        System.Diagnostics.Debug.WriteLine("Guess Number");
                        string xValue = "DefX";
                        if (speechRecognitionResult.SemanticInterpretation.Properties.TryGetValue("number", out recognisedVoiceCommandPhrases))
                        {
                       ...
                       // msgDialog.Content = "Guessed Number " + xValue;
           ...
           rootFrame.Navigate(typeof(MainPage), commandArgs);
